...
export namespace CustomVulkan {
    ...
    struct VulkanCommandBuffer {
        ...
        auto recreateVulkanCommandBuffer() const -> void requires
            std::is_same_v<
                Tag, IVulkanRecreate> {
            initVulkanCommandBuffer(this->ctx);
        }
    ...
    struct VulkanCommandPool {
        ...
        [[nodiscard]] auto createVulkanCommandPool() const -> VulkanCommandBuffer<IVulkanInit> requires std::is_same_v<
            Tag, IVulkanInit> {
