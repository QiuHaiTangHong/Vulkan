...
export namespace CustomVulkan {
    ...
    class VulkanResource {
        public:
            ...
            auto operator=(
                    VulkanResource &&other
                    ) noexcept -> VulkanResource & {
    ...
    struct VulkanTools {
        ...
        static auto findQueueFamilies(
            ...
            const auto queueFamilies = physicalDevice.
        ...
        private:
            ...
            static auto debugCallback(
                    [[maybe_unused]] vk::DebugUtilsMessageSeverityFlagBitsEXT
                    messageSeverity,
                    [[maybe_unused]] vk::DebugUtilsMessageTypeFlagsEXT
                    messageType,
                    const vk::DebugUtilsMessengerCallbackDataEXT *pCallbackData,
                    [[maybe_unused]] void *pUserData
                    ) -> vk::Bool32 {
                std::cerr << "[Vulkan 调试信息]: " << pCallbackData->pMessage <<
                        std::endl;
                return vk::False;
            }
    };
